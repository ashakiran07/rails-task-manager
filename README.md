...
This is a basic Rails app: To Do Manager with the basic CRUD features:
...
Here, we will meet our old friend [**Active Record**](http://guides.rubyonrails.org/active_record_basics.html) again, which is Rails' ORM.
